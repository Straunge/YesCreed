Contributing to Yescreed Core
============================

The Yescreed Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/yescreed-project/yescreed/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Yescreed Core project, and is not to be
confused with overall Yescreed Network Protocol consensus changes.

Whether a pull request is merged into Yescreed Core rests with the project merge
...
Patches that change Yescreed consensus rules are considerably more involved than
...
Where a patchset proposes to change the Yescreed consensus, it must have been
...
The project leader is the release manager for each Yescreed Core release.
